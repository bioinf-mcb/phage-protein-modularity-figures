...
```{r, eval = FALSE}
 ...
 #save(installedpkgs, file=sprintf("%sFigure_Supplementary/Supplementary_Tables/R_packages.rda", OUTPUT.FIGURES.PATH))
  installedpkg2s <- as.vector(tmp)
 #save(installedpkg2s, file=sprintf("%sFigure_Supplementary/Supplementary_Tables/R_packages2da", OUTPUT.FIGURES.PATH))
   installedpkg2s <- as.vector(tmp)
