...
ggsave(sprintf("%sFigure2/H_domains.jpg", OUTPUT.FIGURES.PATH), width = 9, height = 9)
```
...
Fig4b = ggplot(diversity.ok.ecod) + 
  ...
  labs(x = "Number of representative proteins", y = "Number of fold combinations") + 
...
p <- ggplot(data=ecod.table, aes(x=t_name, y=prop.protein.pairs, fill=h_name)) + 
...
p <- p + labs(x = "", y = "Proportion of representative proteins pairs")
