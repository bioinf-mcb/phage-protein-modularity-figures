...
ggsave(sprintf("%sFigure_Supplementary/recent_HGT_domains_pident70.jpg", OUTPUT.FIGURES.PATH), p, width = 15, height = 7)
...
p=ggplot(recent_HGT_pairs_raw.domain.data.to.plot.all.pident90) + geom_col(aes(x = t_name, y = n_pairs, fill = h_name), col = "black") +
  ...
  xlab("") +
  ylab("Num. protein pairs")
ggsave(sprintf("%sFigure_Supplementary/recent_HGT_domains_pident90.jpg", OUTPUT.FIGURES.PATH), p, width = 15, height = 7)
```
