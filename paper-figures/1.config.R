...
OUTPUT.DATA.PATH = sprintf("%spaper-figures/2023-10-20-ULTIMATE/tables/", PROJECT.PATH)
OUTPUT.FIGURES.PATH = sprintf("%spaper-figures/2023-10-20-ULTIMATE/", PROJECT.PATH)
