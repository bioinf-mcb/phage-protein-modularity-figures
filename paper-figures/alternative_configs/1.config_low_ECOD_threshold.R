...
OUTPUT.DATA.PATH = sprintf("%spaper-figures-low-ecod/tables/", PROJECT.PATH)
OUTPUT.FIGURES.PATH = sprintf("%spaper-figures-low-ecod/", PROJECT.PATH)
...
NINIMUM.SCOV.FOR.DOMAIN = 0.5
MINIMUM.PROB.FOR.DOMAIN = 70
