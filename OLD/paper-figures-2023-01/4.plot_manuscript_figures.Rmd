...
ggsave(sprintf("%sFigure2/H_domains.pdf", OUTPUT.FIGURES.PATH), width = 7, height = 10)
ggsave(sprintf("%sFigure2/H_domains.tiff", OUTPUT.FIGURES.PATH), width = 7, height = 10)
