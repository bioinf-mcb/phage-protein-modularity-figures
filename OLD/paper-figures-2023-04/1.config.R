...
source("~/MGG Dropbox/Projects/divRBP/code/protein-mosaicism/paper-figures-2023-04/helpers.R")
...
OUTPUT.DATA.PATH = sprintf("%spaper-figures/2023-04/tables/", PROJECT.PATH)
OUTPUT.FIGURES.PATH = sprintf("%spaper-figures/2023-04/", PROJECT.PATH)
