...
saveRDS(annnotations.and.categories, "/Users/bognasmug/MGG Dropbox/Projects/divRBP/shiny-server/Phage.Domain.Lookup/data/annnotations.and.categories.Rds")
for (this.category in unique(annnotations.and.categories$category)) {
    ...
    #data.table::fwrite(this.tile.data.multi, sprintf("%smultiple_domains.domain.positions_%s.txt", SHINY_DATA_PATH, this.category))
    #data.table::fwrite(this.tile.data, sprintf("%sdomain.positions_%s.txt", SHINY_DATA_PATH, this.category))
